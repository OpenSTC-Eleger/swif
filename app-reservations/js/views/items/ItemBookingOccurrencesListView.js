define([
...
], function(app, AppHelpers, BookingsCollection, ItemBookingOccurrenceView){
	...
	*/
	var itemBookingOccurrencesListView = Backbone.View.extend({
		...
		*/
			...
			$.get(app.moduleUrl+'/templates/' + this.templateHTML + ".html", function(templateData){
				...
				if (!_.isUndefined(self.occurences)) {
					...
					_.each(self.occurences.models, function (occurence) {
						var itemBookingOccurrenceView = new ItemBookingOccurrenceView({model: occurence});
		...
		fetchData: function () {
			...
			self.occurences = new BookingsCollection();
	...
	return itemBookingOccurrencesListView;
