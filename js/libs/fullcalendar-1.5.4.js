...
// Création de la variable pour le UserName //
var username;
		...
		if (buttonStr) {
			$.each(buttonStr.split(' '), function(i) {
				...
				$.each(this.split(','), function(j, buttonName) {
					...
					else if(buttonName == 'infosUser'){

						e.append("<img src='http://mashwork.com/blog/wp-content/uploads/2012/06/Unknown-person2.gif' width='80px' class='img-polaroid'> <span class='lead text-info'>"+username+"</span>");
					}
					else{
						var buttonClick;
...
var iso8601Week = function(date) {
	...
	checkDate.setDate(1);
	var date = Math.floor(Math.round((time - checkDate) / 86400000) / 7) + 1;
	return date;
}
