...
app.Router = Backbone.Router.extend({
	...
	requestsList: function (page) {
		...
		if (this.checkConnect()) {
			...
			if (_.isUndefined(app.collections.categoriesInterventions)) {
				app.collections.categoriesInterventions = new app.Collections.CategoriesInterventions();
			}
			if (_.isUndefined(app.collections.claimersServices)) {
				app.collections.claimersServices = new app.Collections.ClaimersServices();
			}
			if (_.isUndefined(app.collections.categoriesTasks)) {
	...
	interventions: function (page) {
		...
		if (this.checkConnect()) {
			...
			if (_.isUndefined(app.collections.tasks)) {
			...
			if (_.isUndefined(app.collections.equipments)) {
	...
	planning: function (id) {
		...
		if (this.checkConnect()) {
			...
			if (_.isUndefined(id)) {
				...
				if (_.isUndefined(app.collections.teams)) {
				...
				if (_.isUndefined(app.collections.absentTypes)) {
	...
	services: function (page) {
		...
		if (this.checkConnect()) {
			...
			if (_.isUndefined(app.collections.stcGroups)) {
		...
		if (this.checkConnect()) {
			...
			app.collections.claimers.fetch({
				success: function () {
					...
					$.when(
							app.collections.claimersTypes.fetch({search: [
								['code', '<>', 'ADMINISTRE']
							]}),
							app.collections.claimersServices.fetch(),
							app.collections.places.fetch(),
