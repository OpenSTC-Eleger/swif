...
], function(app, AppHelpers, ContractModel, ContractsCollection, GenericModalView){
			...
			this.model.save(params)
				.done(function(data) {
					...
					if(self.model.isNew()) {
						...
						self.model.fetch({silent: true, data : {fields : ContractsCollection.prototype.fields} }).done(function(){
